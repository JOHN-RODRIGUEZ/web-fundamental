...
<head>
    ...
    <title>Sistema-Farmacia-Realizar Ventas</title>
</head>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                SISTEMA DE FARMACIA-Realizar Ventas
                ...
                <div class="panel-body">
                                    ...
                                    <td>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value=" " class="form-control" name="cantidad_agregado">
                                                <a href="actualizar_m.php?id_m=<?php echo $id_medicamento;?>" class="btn btn-success"><i class="fa fa-pencil"></i>Agregar</a>
                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            foreach ($medicamentos as $medicamento){
                                ...
                                $sumar_precio_venta_total = $sumar_precio_venta_total +$precio_venta_total;
                                $utilidad_total = $sumar_precio_venta_total-$sumar_precio_real_total;
                                $precio_total_medicamento = $precio_venta_unitario * $cantidad_agregado;
                                ?>
                                <tr>
                                    ...
                                    <td align="center" ><?php echo $laboratorio;?></td>
                                    <td align="center" ><?php echo $presentacion;?></td>
                                    <td align="center" ><?php echo $cantidad_agregado;?></td>
                                    <td align="center" ><?php echo $precio_venta_unitario;?></td>
                                    <td align="center" ><?php echo $precio_total_medicamento;?></td>
                                    <td>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo $cantidad_medicamento." Bs"?>" class="form-control" disabled>
                        </div>
