...
<head>
    ...
    <title>Sistema-Farmacia-Actualizacion Medicamentos</title>
</head>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                SISTEMA DE FARMACIA-Actualizacion de Medicamentos
        ...
        <section class="content">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <form action="controller_actu_medicamentos.php" method="post">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModal_presentacion">
                                        Añadir
                                    </button>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"name="cantidad_cajas" value="<?php echo $cantidad_cajas;?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Cantidad en Unidades </label>
                                    <input type="text" class="form-control"name="cantidad_unidades" value="<?php echo $cantidad_unidades;?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Cantidad Total</label>
                                    <input type="text" class="form-control"name="cantidad_total" value="<?php echo $cantidad_total;?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Precio real en caja</label>
                                    <input type="text" class="form-control"name="precio_real_caja" value="<?php echo $precio_real_caja;?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Precio real en unidades</label>
                                    <input type="text" class="form-control"name="precio_real_unitario"value="<?php echo $precio_real_unitario;?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Precio real Total</label>
                                    <input type="text" class="form-control"name="precio_real_total"value="<?php echo $precio_real_total;?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Precio de Venta Caja</label>
                                    <input type="text" class="form-control"name="precio_venta_caja" value="<?php echo $precio_venta_caja;?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Precio de Venta Unidad</label>
                                    <input type="text" class="form-control"name="precio_venta_unitario"value="<?php echo $precio_venta_unitario;?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Precio de Venta Total</label>
                                    <input type="text" class="form-control"name="precio_venta_total"value="<?php echo $precio_venta_total;?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control"name="fecha_entrega_medicamento" value="<?php echo $fecha_entrega_medicamento;?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Fecha de Vencimiento del Medicamento</label>
                                    <input type="date" class="form-control"name="fecha_vencimineto" value="<?php echo $fecha_vencimineto;?>">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"name="stock_maximo_unidades" value="<?php echo $stock_maximo_unidades;?>">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"name="stock_minimo_unidades" value="<?php echo $stock_minimo_unidades;?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <center>
                                    ...
                                    <input type="submit" class="btn btn-success btn-lg" value="Actualizar Medicamento">
                                </center>
